...
namespace Covid.Data.Dtos
{
    ...
    public class AuditHeaderDto
    {
        ...
        /// </summary>
        public EAuditEvent AuditEvent { get; private set; }
        ...
        /// Gets the Username.
        /// </summary>
        [MaxLength(Domain.DomainObjects.AuditHeaders.Metadata.Username.MaxLength)]
        [Required]
        ...
        /// </summary>
        /// <returns>Audit Header.</returns>
        public IAuditHeaderWithAuditDetails ToDomainWithAuditDetails()
        {
            return new AuditHeaderWithAuditDetails(
                ...
                username: this.Username,
                correlationId: this.CorrelationId,
                auditDetails: this.AuditDetails.Select(ad => ad.ToDomain()).ToList());
        }
